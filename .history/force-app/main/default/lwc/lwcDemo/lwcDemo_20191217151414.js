...
import fatchPickListValue from '@salesforce/apex/LwcDemo.getPicklistValues';
...
// pass 'object information' and 'picklist field API name' method params which we need to fetch from apex
 @wire(fatchPickListValue, {objName: {'sobjectType' : 'Opportunity'},
                            fldName: 'StageName'}) stageNameValues;
